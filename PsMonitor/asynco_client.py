...
def get_data():
    ...
    for os in c.Win32_OperatingSystem():
        up_time = os.LastBootUpTime.split('.')[0]
        print(up_time)
        last_boot_time = datetime.strptime(up_time, '%Y%m%d%H%M%S')
        #last_boot_time = datetime.strptime(up_time, '%Y%m%d%I%M%S')
...
if __name__ == '__main__':
    ...
    loop.run_until_complete(echo_client(('10.101.42.127', 25000),loop))
